<x-post-layout>
    ...
    <div class="max-w-4xl p-6 mx-auto mt-10 bg-white rounded-lg shadow-md dark:bg-transparent">
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <img id="image-preview"
                        src="{{ old('image') ? asset('storage/' . old('image')) : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5Sh209MMxKFXtyWOKLVXe-JjSc7_eFz-p6g&s' }}"
                        alt="Preview" class="object-cover w-32 h-32 border border-gray-300 rounded">
